...
#line hidden
#line 15
 testRunner.And(string.Format("I update \'{0}\', \'{1}\' and \'{2}\' on an exsisting time and material record", description, code, price), ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "And ");
#line hidden
#line 16
